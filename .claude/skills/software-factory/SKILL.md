...
description: >
  Drive @adam/software-factory runs: a fully generic, model-driven state
...
Drive `@adam/software-factory` model instances. A factory instance is a
...
6. **Ask the platform, not your memory.** When unsure of a method's
   ...
   `swamp model type describe @adam/software-factory` returns the full
...
```
swamp model create @adam/software-factory <factory-name>
...
Definitions can be seeded from the extension's `examples/` (minimal,
feature-factory, sdlc-classic) — read
...
| Discover the method surface  | `swamp model type describe @adam/software-factory`                                                                                                                                   |
