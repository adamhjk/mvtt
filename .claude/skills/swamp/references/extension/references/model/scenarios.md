      ...
      execute: async (
        ...
        const response = await fetch("https://api.stripe.com/v1/customers", {
          ...
          body: new URLSearchParams({
            email: args.email,
            name: args.name,
            ...(args.metadata && { "metadata[key]": JSON.stringify(args.metadata) }),
          }),
        });
        ...
        const handle = await context.writeResource("customer", "primary", customer);
  ...
  methods: {
    create: {
      ...
      execute: async (
        ...
        const handle = await context.writeResource("bucket", "main", bucketData);
        return { dataHandles: [handle] };
      },
    },
    update: {
      ...
      execute: async (
        ...
        const handle = await context.writeResource("bucket", "main", updatedData);
        return { dataHandles: [handle] };
      },
    },
    delete: {
      ...
      execute: async (
        ...
        const cmd = new Deno.Command("aws", {
          args: ["s3api", "delete-bucket", "--bucket", bucketData.Name],
          stdout: "piped",
          stderr: "piped",
        });
        const output = await cmd.output();
    ...
    sync: {
      ...
      execute: async (
        ...
        const headCmd = new Deno.Command("aws", {
          args: ["s3api", "head-bucket", "--bucket", bucketName],
          stdout: "piped",
          stderr: "piped",
        });
        ...
        const versioningCmd = new Deno.Command("aws", {
          args: ["s3api", "get-bucket-versioning", "--bucket", bucketName, "--output", "json"],
          stdout: "piped",
          stderr: "piped",
        });
        ...
        const handle = await context.writeResource("bucket", "main", refreshedData);
        return { dataHandles: [handle] };
      },
    },
  },
  ...
  methods: {
    scan: {
      ...
      execute: async (
        ...
        const cmd = new Deno.Command("aws", {
          args: ["ec2", "describe-vpcs", "--region", region, "--output", "json"],
          stdout: "piped",
          stderr: "piped",
        });
        const output = await cmd.output();
