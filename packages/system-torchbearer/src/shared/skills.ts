...
export const ADVENTURING_SKILLS: ReadonlyArray<SkillEntry> = [
  {
    ...
    source: { book: "DH", page: 249 },
    suggestedHelp: ["loreMaster", "laborer"],
  },
  {
    id: "arcanist",
    name: "Arcanist",
  ...
  },
  {
    ...
    category: "adventuring",
    source: { book: "DH", page: 249 },
    suggestedHelp: ["sapper", "survivalist"],
  },
  {
    id: "fighter",
    name: "Fighter",
  ...
  },
  {
    ...
    category: "adventuring",
    source: { book: "DH", page: 249 },
    suggestedHelp: ["survivalist", "alchemist"],
  },
  {
    id: "hunter",
    name: "Hunter",
    ...
    category: "adventuring",
    source: { book: "DH", page: 249 },
    suggestedHelp: ["survivalist", "laborer"],
  },
  {
    id: "loreMaster",
    name: "Lore Master",
    ...
    category: "adventuring",
    source: { book: "DH", page: 249 },
    suggestedHelp: ["arcanist", "theologian"],
  },
  {
    id: "manipulator",
    name: "Manipulator",
    ...
    category: "adventuring",
    source: { book: "DH", page: 249 },
    suggestedHelp: ["haggler", "persuader"],
  },
  {
    id: "mentor",
    name: "Mentor",
  ...
  },
  {
    ...
    category: "adventuring",
    source: { book: "DH", page: 249 },
    suggestedHelp: ["scout", "cartographer"],
  },
  {
    id: "persuader",
    name: "Persuader",
  ...
  },
  {
    ...
    category: "adventuring",
    source: { book: "DH", page: 249 },
    suggestedHelp: ["loreMaster", "steward"],
  },
  {
    id: "scout",
    name: "Scout",
  ...
  },
  {
    ...
    category: "adventuring",
    source: { book: "DH", page: 249 },
    suggestedHelp: ["scholar", "ritualist"],
  },
];
...
export const TOWN_SKILLS: ReadonlyArray<SkillEntry> = [
  ...
  },
  {
    ...
    category: "town",
    source: { book: "DH", page: 249 },
    suggestedHelp: ["scholar", "theologian"],
  },
  {
    id: "stonemason",
    name: "Stonemason",
...
export const LORE_MASTER_SKILLS: ReadonlyArray<SkillEntry> = [
  {
    ...
    bl: "will",
    category: "lmm",
    source: { book: "LMM", page: 36 },
    suggestedHelp: ["orator", "manipulator"],
  },
  {
    id: "butcher",
    name: "Butcher",
    bl: "health",
    category: "lmm",
    source: { book: "LMM", page: 37 },
    suggestedHelp: ["cook", "laborer"],
  },
  {
    id: "enchanter",
    name: "Enchanter",
    ...
    category: "lmm",
    source: { book: "LMM", page: 37 },
    suggestedHelp: ["alchemist", "arcanist"],
  },
  {
    id: "fisher",
    name: "Fisher",
    bl: "will",
    category: "lmm",
    source: { book: "LMM", page: 38 },
    suggestedHelp: ["laborer", "sailor"],
  },
  {
    id: "jeweler",
    name: "Jeweler",
  ...
  },
  {
    ...
    bl: "will",
    category: "lmm",
    source: { book: "LMM", page: 40 },
    suggestedHelp: ["commander", "scholar", "steward"],
  },
  {
    id: "tanner",
    name: "Tanner",
...
const BY_ID: ReadonlyMap<string, SkillEntry> = new Map(ALL_SKILLS.map((s) => [s.id, s] as const));
