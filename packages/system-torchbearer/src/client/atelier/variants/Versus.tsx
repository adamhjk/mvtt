...
import { OpponentCard } from "../cards/OpponentCard.jsx";
...
/**
 * Versus test variant — pool + opponent mirror on top, then the universal
...
export function TbVersusEditor(props: { atelier: AtelierState }): JSX.Element {
  return (
    <div class="grid gap-3 sm:grid-cols-2" data-testid="atelier-variant-versus">
      ...
      <OpponentCard atelier={props.atelier} />
      <div class="sm:col-span-2">
        <ModifiersCard atelier={props.atelier} mode="versus" />
      </div>
