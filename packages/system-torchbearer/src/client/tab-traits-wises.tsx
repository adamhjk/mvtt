  ...
  return (
    <div style={{ display: "flex", "flex-direction": "column", gap: "1rem" }}>
      <kit.SheetSection title="Traits">
        <SectionLegend>
          <strong>Lv 1</strong> grants +1D to one roll per session · <strong>Lv 2</strong> grants
          +1D to two rolls per session · <strong>Lv 3</strong> grants +1s to each tied or passed
          test associated with the trait. Lv 1 and Lv 2 uses refresh after the prologue at the start
          of a new session. <strong>Checks</strong> are earned by using a trait against yourself:
          −1D on your own roll for 1 check, +2D for an opponent or breaking a tie in their favor for
          2 checks. You may only use a trait against yourself once per session, and never in camp,
          town, or PvP. Spend checks in camp (1 check per test) or as you enter town (1 check per
          recovery test). The <strong>vs Self</strong> box auto-fills on an against-self use; flip
          it back at session start. <RuleRef book="DH" page={79} /> <RuleRef book="DH" page={80} />{" "}
          <RuleRef book="DH" page={81} /> <strong>Trait list:</strong>{" "}
          <RuleRef book="DH" page={177} /> <RuleRef book="LMM" page={29} />
        </SectionLegend>
        <kit.EntryRowsField<TraitEntry>
          ...
          columns={[
            ...
            },
            {
              key: "beneficialUses",
              type: "dots",
              label: "Beneficial Uses",
              max: (e) => e.level,
              placeholder: (e) => (e.level >= 3 ? "all" : null),
              width: "5.5rem",
              align: "center",
            },
            {
      ...
      <kit.SheetSection title="Wises">
        <SectionLegend>
          A wise is special, esoteric knowledge of a narrow subject — it has no rating and is never
          tested on its own. Used once per test (multiple wises per test are fine, but a different
          effect each), to one of three ends: <strong>I Am Wise</strong> grants +1D <em>aid</em> to
          a friend or ally on a related test (cannot help and use I-Am-Wise on the same test);{" "}
          <strong>Deeper Understanding</strong> spends 1 fate to reroll one failed die on a related
          roll; <strong>Of Course!</strong> spends 1 persona to reroll all failed dice on a related
          test (use this before Luck). Mark all four boxes — I-Am-Wise on a passed test, I-Am-Wise
          on a failed test, Deeper Understanding, Of Course! — to <strong>Gain Wisdom</strong>:
          change the wise, take a Beginner's Luck test toward a new skill, or take a related skill
          advancement test. Then reset and try again. Maximum of four wises at once; new wises
          arrive in respite. <RuleRef book="DH" page={76} /> <RuleRef book="DH" page={77} />{" "}
          <RuleRef book="DH" page={78} /> <RuleRef book="SG" page={126} />
        </SectionLegend>
          ...
          columns={[
            {
              ...
              type: "text",
              label: "Wise",
              placeholder: "what you're wise to",
              maxLength: 80,
              width: "minmax(10rem, 2.4fr)",
            },
